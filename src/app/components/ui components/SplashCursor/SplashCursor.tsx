...
type SplashCursorColor = { r: number; g: number; b: number };
...
class PointerPrototype implements Pointer {
  ...
  down = false;
  moved = false;
  color: SplashCursorColor = { r: 0, g: 0, b: 0 };
}
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement): {
      ...
      let formatRGBA: WebGLTextureFormat | null = null;
      let formatRG: WebGLTextureFormat | null = null;
      let formatR: WebGLTextureFormat | null = null;
    ...
    function getUniforms(program: WebGLProgram): ProgramUniforms {
      ...
      for (let i = 0; i < uniformCount; i++) {
        ...
        const uniformName = activeUniform ? activeUniform.name : "";
    ...
    function generateColor(): SplashCursorColor {
    ...
    function HSVtoRGB(h: number, s: number, v: number): SplashCursorColor {
      let r = 0,
        g = 0,
        b = 0;
